...
_Generated from repo sources at commit `ff9c5f1` · coordination data as of **2026-07-23** (last `docs/coordination` commit) · ATL-021 / DL-013_
...
| Current version | pre-release @ ff9c5f1 (last source commit; no git tags yet) |
